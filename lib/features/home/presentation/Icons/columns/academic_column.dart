...
import 'package:kfupm_app/features/home/presentation/Icons/services/GPA/GPA_screen.dart';
        ...
        InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => GradesAndGpa()));
            },
            child: const ColElement(
                icon: Icons.card_membership, text: "Grades and Gpa")),
        InkWell(
            onTap: () {
              Navigator.push(context,
